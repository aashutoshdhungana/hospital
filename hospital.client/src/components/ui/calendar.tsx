  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "relative bg-background border rounded-md p-1.5 text-sm font-medium hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary",
        dropdown_month: "mr-1",
        dropdown_year: "ml-1",
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-10 font-medium text-xs uppercase tracking-wider",
